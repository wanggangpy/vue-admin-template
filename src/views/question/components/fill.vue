<template>
  <div class="app-container">
    <el-card class="question-card">
      <h1 class="question-title">{{ questionData.title }}</h1>
      <el-form :rules="fillQuestionRules">
      <el-row :gutter="20">
        <el-col :lg="{span: 10, offset:7}" :xs="{span:22, offset:1}">
          <div class="content-box" v-for="(content, cindex) in questionData.content" :key="cindex" :style="{'border-bottom': (cindex === questionData.content.length ? '0px': '1px dashed red;')}">
        ...
        <el-col :span="10" :offset="7"><el-button type="primary" size="medium" style="width:100%" @click="commitQuestion()">提交</el-button></el-col>
      </el-row>
      </el-form>
    </el-card>
  </div>
...
<script>
import { resultQuestion } from '@/api/w'

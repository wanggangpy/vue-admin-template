    ...
    <el-card class="question-card">
      ...
      <el-row :gutter="20">
        <el-col :lg="{span: 10, offset:7}" :xs="{span:22, offset:1}">
          <div class="content-box" v-for="(content, cindex) in evaluationData.content" :key="cindex" :style="{'border-bottom': (cindex === evaluationData.content.length ? '0px': '1px dashed red;')}">
